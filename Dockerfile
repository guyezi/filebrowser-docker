...
LABEL maintainer="guyezi" \
    ...
    org.label-schema.url="https://github.com/guyezi/filebrowser-docker" \
    org.label-schema.license="MIT" \
    org.label-schema.vcs-ref=$VCS_REF \
    org.label-schema.vcs-url="https://github.com/guyezi/filebrowser-docker" \
    org.label-schema.vcs-type="Git" \
    org.label-schema.vendor="guyezi" \
